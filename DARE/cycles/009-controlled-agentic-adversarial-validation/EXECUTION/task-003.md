# task-003 — Define Adversarial Test Vector schema
...
Create bounded data-only vectors with operation, arguments, expectations, stop conditions and preconditions.
