# task-005 — Define ROE authorization gate
...
Validate target, environment, identities, capabilities, categories, data classes, time window, egress and prohibited operations.
